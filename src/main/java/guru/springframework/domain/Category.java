...
public class Category {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof guru.springframework.domain.Category)) return false;
        final guru.springframework.domain.Category other = (guru.springframework.domain.Category) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof guru.springframework.domain.Category;
    }
